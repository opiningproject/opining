    ...
    <div class="modal-content">
      ...
      <div class="modal-body signin-form">
        <form>
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#forgotPasswordModal" class="btn btn-custom-yellow fw-400 text-uppercase font-sebibold w-100 mt-30px">Send Password Resent Link</a>
        </form>
      </div>
    </div>
  </div>
</div><?php /**PATH /var/www/html/go-meal/resources/views/user/modals/forgot-password.blade.php ENDPATH**/ ?>