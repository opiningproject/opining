            ...
            <div class="container-fluid bd-gutter bd-layout"> @include('layouts.user.side_nav_bar')
             ...
             <span class="form-control-feedback">
                                        ...
                                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                           sketch:type="MSPage">
                                            <g id="Icon-Set" sketch:type="MSLayerGroup"
                                               transform="translate(-572.000000, -723.000000)"
                                               fill="#FFC00B">
                                                <path
                ...
                <aside class="cart-sidebar sticky-top h-lg-100vh cartSidebarCustom">
                    ...
                    <div class="offcanvas-xxl offcanvas-end h-100 overflow-auto cartoffCanvas" tabindex="-1" id="bdSidebarCart"
                        ...
                        <div class="offcanvas-body position-relative space-for-close pb-xxl-3">
                            ...
                            <span class="input-group-icon">
                              <img src="{{ asset('images/scoter-yellow.svg') }}" alt="" class="svg img-fluid"
                                   height="22"
                                   width="25">
                                ...
                                <span class="input-group-icon">
                                  <img src="{{ asset('images/coupon-code.svg') }}" alt="" class="svg img-fluid"
                                       height="18"
                                       width="29">
                                                            ...
                                                            <div class="bill-detail-invoice">
                                                                <h6 class="cart-title mb-1 d-none d-md-block">Bill Details</h6>
                           ...
                           href="javascript:void(0)">
                                                                    <span class="align-middle"><span class="count_cart"><span
                                                                                class="count_num" id="cart-count-sticky">{{ isset(Auth::user()->cart) ? Auth::user()->cart->dishDetails->count() : 0 }}</span> <svg
                                                                                width="22px" height="22px"
                                                                                viewBox="-4 0 32 32" version="1.1"
                                                                                xmlns="http://www.w3.org/2000/svg"
                                                                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                                xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
                                        <defs></defs>
                                               ...
                                               fill="#333333">
                                                <path
                                                    ...
                                                    <div class="empty-card-div w-100 mt-lg-5 pt-lg-5"
                                                        ...
                                                        <p class="empty-card-text text-muted-1 mb-2"> Your cart is
                                                            empty </p>
                                                        <span>
