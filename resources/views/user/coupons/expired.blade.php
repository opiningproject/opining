<div class="tab-pane fade" id="expired-tab-pane" role="tabpanel" aria-labelledby="expired-coupons-tab" tabindex="0">
    <section class="">
                                ...
                                <div class="promocode-box">
                                    ...
                                    @else
                                        <p class="mb-0 d-inline-block">
                                            {{ trans('user.coupons.earn_points', ['points' => $coupon->points]) }}</p>
                                    @endif
                                </div>
