                                    ...
                                    <div class="input-group justify-content-end text-end">
                                        <?php if(Route::has('password.request')): ?>
                                            <a href="#" data-bs-toggle="modal"
                                               ...
                                               class="text-capitalize lead-2 font-regularcustom"><?php echo e(__('Forgot Your Password?')); ?></a>
                                        <?php endif; ?>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body signin-form">
                        <form method="POST" action="javascript:void(0)">
                            <?php echo csrf_field(); ?>
                            <h3 class="authenticationform-title"><?php echo e(__('Reset Password')); ?></h3>
                            ...
                            <span class="input-group-icon">
                                ...
                                <input type="text" name="forgot-pwd-email" id="forgot-pwd-email" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Email" value="<?php echo e($email ?? old('email')); ?>" autocomplete="email" autofocus>
                            </div>
                            ...
                            <button type="submit" id="forgot-pwd--submit-btn"
                                    class="btn btn-custom-yellow fw-400 text-uppercase font-sebibold w-100 mt-30px"><?php echo e(__('Send Password Reset Link')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/go-meal/resources/views/auth/login.blade.php ENDPATH**/ ?>