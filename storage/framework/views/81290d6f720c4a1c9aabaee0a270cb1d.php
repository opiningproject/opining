                                ...
                                <div class="col text-end">
                                    <div class="page-control">
                                        <div class="row justify-content-end align-items-center g-0">
                                            ...
                                            <div class="col-auto">
                                                <a class="btn btn-custom-yellow" href="<?php echo e(route('addDish')); ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                         viewBox="0 0 20 20" fill="none">
                                                        <circle cx="10" cy="10" r="10" fill="#292929"/>
                                                        <path
                                        ...
                                        <div class="category-element swiper-slide">
                                            <div class="card">
                                                <span class="dish-item-icon">
                                                    <img src="<?php echo e($category->image); ?>" class="img-fluid" alt="bakery">
                                                </span>
                                                <p class="mb-0 category-item-name"><?php echo e((app()->getLocale() == 'en') ? $category->name_en : $category->name_nl); ?></p>
                            ...
                            <div class="popular-item-grid">
                                ...
                                ?>
                                    ...
                                    <div class="card-body p-0">
                                        <p class="quantity-text badge">Qty:<?php echo e($dish->qty); ?></p>
                                        <div class="food-image">
                                            <img src="images/burger-svg.svg" alt="burger imag" class="img-fluid"/>
                                        </div>
                                        <h4 class="food-name-text"><?php echo e((app()->getLocale() == 'en') ? $dish->name_en : $dish->name_nl); ?></h4>
                                        <p class="food-price">€20</p>
                                        <div class="food-detail-card-btn">
                                            <a href="<?php echo e(route('editDish', $dish->id)); ?>" class="btn btn-custom-yellow btn-icon" data-id="<?php echo e($dish->id); ?>">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a class="btn btn-custom-yellow btn-icon" data-bs-toggle="modal"
                                               data-bs-target="#deleteDishAlertModal" data-id="<?php echo e($dish->id); ?>">
                                                <i class="fa-regular fa-trash-can"></i>
                                            </a>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/go-meal/resources/views/admin/home.blade.php ENDPATH**/ ?>