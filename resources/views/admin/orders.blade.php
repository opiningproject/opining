                    ...
                    <div class="main-content d-flex flex-column h-100">
                        <div class="section-page-title mb-0 d-flex align-items-center justify-content-between gap-2 foodorder-page-title">
                            ...
                            <div class="btn-grp d-flex align-items-center flex-wrap">
                                ...
                                <!-- <button class="btn d-flex align-items-center bg-white dropdown-btn">
                                    <img src="images/user-img.png" alt="img" class="img-fluid" width="44">
                                    <div class="text-grp d-flex flex-column align-items-start">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" href="#">gomeal</a>
                                              <a class="dropdown-item" href="#">gomeal</a>
                                              <a class="dropdown-item" href="#">gomeal</a>
                                            </div>
                                        </div>
                                        <div class="text">gomeal@gmail.com</div>
                                    </div>
                                </button> -->
                            </div>
                        </div>
