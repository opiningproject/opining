<div class="tab-pane fade" id="zipCode-tab-pane" role="tabpanel" aria-labelledby="zipCode-tab" tabindex="0">
    ...
    <h2 class="content-title">Zip Code</h2>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center">
                                    {{ trans('rest.settings.zipcode.min_order_price') }}</th>
                                <th scope="col" class="text-center">
                                    {{ trans('rest.settings.zipcode.delivery_charges') }}</th>
                                <th scope="col" class="text-center" width="20%">
                                    {{ trans('rest.settings.zipcode.status') }}</th>
                                <th scope="col" class="text-center" width="13%">{{ trans('rest.button.action') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody id="est">
                            <tr class="zipcode-row-0">
                                <td>
                                    <input type="text" class="form-control text-center w-10r m-auto zipcode-text"
                                        id="zipcode_0" name="zipcode" />
                                </td>
                                <td class="text-center">
                                    <div class="input-group w-5r m-auto">
                                        <span class="input-group-text" id="basic-addon1">€</span>
                                        <input type="number" class="form-control m-auto" min="0"
                                            id="min_order_price_0" name="min_order_price" />
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="input-group w-5r m-auto">
                                        <span class="input-group-text" id="basic-addon1">€</span>
                                        <input type="number" class="form-control m-auto" min="0"
                                            id="delivery_charge_0" name="delivery_charge" />
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="form-check form-switch custom-switch justify-content-center ps-0">
                                        <input class="form-check-input" type="checkbox" role="switch" id="status_0"
                                            checked>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-site-theme text-uppercase font-sebibold w-100"
                                        id="zipcode-save-btn-0" onclick="saveZipcode(0)">
                                    ...
                                    <td class="text-center">
                                        <div class="form-check form-switch custom-switch justify-content-center ps-0">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                ...
                                                onchange="changeStatus({{ $zipcode['id'] }})">
                                        </div>
                                    </td>
                                    <td class="">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-site-theme btn-icon" tabindex="0"
                                                href="javascript:void(0);" id="zipcode-edit-btn-{{ $zipcode['id'] }}"
                                                onclick="editZipcode({{ $zipcode['id'] }})">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a class="btn btn-site-theme btn-icon"
                                            ...
                                            <button type="button"
                                                class="btn btn-site-theme text-uppercase font-sebibold w-100"
