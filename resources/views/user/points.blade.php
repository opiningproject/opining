...
@section('content')
    ...
    <div class="main">
        <div class="main-view">
            <div class="container-fluid bd-gutter bd-layout">
                ...
                <main class="bd-main order-1">
                    <div class="main-content mobile-minus-margin">
                        ...
                        <section class="custom-section informativeterms-section h-100 pb-0 pt-0">
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header">
                                                            <button
                                                                ...
                                                                data-bs-target="#coupon-collapse-{{ $coupon->id }}"
                                                                aria-expanded="true"
                                                                aria-controls="coupon-collapse-{{ $coupon->id }}">
                                                                <div class="acc-header">
                                                                    ...
                                                                    <div class="con-title">
                                                                        <h3 class="mb-1">{{ $coupon->percentage_off }}%
                                                                            discount coupon</h3>
                                                                        @if ($user->collected_points < $coupon->points)
                                                                            <p
                                                                                class="mb-0 d-flex align-items-center free-coins">
                                                                                {{ trans('user.coupons.earn_points', ['points' => $coupon->points]) }}
                                                                                {!! $leftDays !!}</p>
                                                                        @elseif($coupon->points > 0)
                                                                            <p
                                                                                class="mb-0 d-flex align-items-center free-coins">
                                                                                {{ trans('user.coupons.earned_points', ['points' => $coupon->points]) }}
                                                                                Points {!! $leftDays !!}</p>
                                                                        @elseif($coupon->points == 0)
                                                                            <p
                                                                                class="mb-0 d-flex align-items-center free-coins">
                                                                                {{ trans('user.coupons.free_points') }}
                                                                                {!! $leftDays !!}</p>
                                                                        @endif
                                                        ...
                                                        <div id="coupon-collapse-{{ $coupon->id }}"
                                                            class="accordion-collapse collapse {{ $key == 0 ? 'show' : '' }}"
                                                            data-bs-parent="#accordionExample">
                                                            <div class="accordion-body">
                                                                <h3>Conditions</h3>
                                                                <ul class="mb-3">
                                                                    <li>{{ trans('user.coupons.min_order') }}
                                                                        €{{ $coupon->price }}</li>
            ...
            <!-- start toaster -->
            <div class="toast align-items-center bg-yellow border-yellow show custom-toast rounded-0 d-none" role="alert"
