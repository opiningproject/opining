...
@section('content')
                                    ...
                                    <div class="card-body py-0">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="form-group imageupload-box inline-imageupload-box">
                                                    <label for="dishimage"
                                                           class="form-label">{{ trans('rest.menu.dish.dish_image') }}</label>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label for="dishnamedutch"
                                                           class="form-label">{{ trans('rest.menu.dish.dish_name') }}
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="form-group ">
                                                    <label for="dishcategory"
                                                           class="form-label">{{ trans('rest.menu.dish.category') }}</label>
                                                    <select class="form-control dropdown-toggle w-100" type="button"
                                                            data-bs-toggle="dropdown" name="category_id"
                                                            aria-expanded="false">
                                                        <option
                                                            value="">{{ trans('rest.menu.dish.select_category') }}</option>
                                                        @foreach ($categories as $category)
                                                            <option
                                                                value="{{ $category->id }}" {{ $category->id == $dish->category_id ? 'selected' : '' }}> {{ $category->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label
                                                        class="form-label">{{ trans('rest.menu.dish.discount_per') }}</label>
                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label for="dishprice"
                                                           class="form-label">{{ trans('rest.menu.dish.dish_price') }}</label>
                                            ...
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label for="discountpercentage"
                                                           class="form-label">{{ trans('rest.menu.dish.description') }}
                                                        <span class="text-custom-muted">(English)</span>
                                                    </label>
                                                    <input type="text" class="form-control" value="{{ $dish->desc_en }}"
                                                           id="desc_en" name="desc_en"/>
                                                </div>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                                ...
                                                                <div class="input-group w-100">
                                                                    <div
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option
                                                                                value=""> {{ trans('rest.menu.dish.select_ingred_category') }}</option>
                                                                ...
                                                                <div class="input-group w-100">
                                                                    <div
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            id="freeIngredient">
                                                                            <option
                                                                                value="">{{ trans('rest.menu.dish.select_ingred') }}
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th scope="col" class="text-center"
                                                        width="12%">{{ trans('rest.menu.dish.image') }}</th>
                                                    <th scope="col"
                                                        class="text-center">{{ trans('rest.menu.dish.name') }}</th>
                                                    <th scope="col"
                                                        class="text-center">{{ trans('rest.menu.dish.ingred_categories') }}</th>
                                                    <th scope="col" class="text-center"
                                                        width="11%">{{ trans('rest.button.action') }}</th>
                                                </tr>
                                                </thead>
                                                        ...
                                                        <tr id="dishIngredient{{ $freeIngredient->id }}">
                                                            <td class="text-center">
                                                                <img src="{{ $freeIngredient->ingredient->image }}"
                                                                     class="img-fluid me-15px" style="height: 50px"/>
                                                            </td>
                                                            <td class="text-center">
                                                                <input type="text"
                                                                ...
                                                                <div class="input-group w-100">
                                                                    <div
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            name="ingredient_id">
                                                                            <option
                                                                                value="">{{ trans('rest.menu.dish.select_ingred') }}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col"
                                                        class="text-center">{{ trans('rest.menu.dish.ingred_categories') }}</th>
                                                    <th scope="col"
                                                        class="text-center">{{ trans('rest.menu.dish.price') }} </th>
                                                    <th scope="col" class="text-center"
                                                        width="11%">{{ trans('rest.button.action') }}</th>
                                                </tr>
                                                </thead>
    ...
    <div class="modal fade custom-modal" id="deleteAlertModal" tabindex="-1" aria-labelledby="deleteAlertModal"
         aria-hidden="true">
...
@section('script')
    <script>
        var dishValidation = {
            select_option: '{{ trans('rest.menu.dish.select_option') }}',
            save_ingredient: '{{ trans('rest.menu.dish.save_ingredient') }}',
            select_ingred: '{{ trans('rest.menu.dish.select_ingred') }}',
            select_category: '{{ trans('rest.menu.dish.select_category') }}',
            option: '{{ trans('rest.menu.dish.option') }}',
