                    ...
                    <div class="main-content">
                        ...
                        <section class="custom-section">
                            <div class="card editdish-card">
                                <form id="editDishForm" enctype="multipart/form-data"> @csrf <div
                                        class="card-header border-0 bg-white border-bottom-0">
                                        <div class="row">
                                                ...
                                                <div class="form-group mb-0 mt-2">
                                                    <div
                                                        ...
                                                        <label class="form-check-label form-label mb-0 me-2"
                                                            for="outofstock">Out of stock</label>
                                                        ...
                                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                            <div class="form-group">
                                                                <label class="form-label">
                                                                    <strong>Ingredients categories</strong>
                                                                </label>
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            @foreach ($ingredientCategories as $ingredientCategory)
                                                                                <option
                                                                                    ...
                                                                                    {{ App()->getLocale() == 'en' ? $ingredientCategory->name_en : $ingredientCategory->name_nl }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
