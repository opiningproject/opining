                    ...
                    <div class="section-page-title mb-0 d-flex align-items-center justify-content-between gap-2 foodorder-page-title">
                        ...
                        <div class="btn-grp d-flex align-items-center flex-wrap">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('orders',['date_filter'=>1]) }}">{{ trans('rest.food_order.today') }}</a></li>
                                <li><a class="dropdown-item" href="{{ route('orders',['date_filter'=>2]) }}">{{ trans('rest.food_order.week') }}</a></li>
                                <li><a class="dropdown-item" href="{{ route('orders',['date_filter'=>3]) }}">{{ trans('rest.food_order.month') }}</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                @if(count($orders))
                                    ...
                                    <div class="{{ $key == 0 ? 'active':'' }} foodorder-box-list-item d-flex" onclick="orderDetail({{ $ord->id }})" id="order-{{ $ord->id }}">
                                        <div class="details w-100 d-flex flex-column gap-3">
                                            <div class="title">{{ trans('rest.food_order.order') }} #{{$ord->id}} | {{ $ord->created_at }}</div>
                                            <div class="icontext-grp d-flex align-items-center justify-content-between">
                                                <div class="icontext-item d-flex align-items-center gap-1">
                                                    ...
                                                    <div class="text">{{ $ord->order_type == OrderType::Delivery ? trans('rest.food_order.delivery'):trans('rest.food_order.pickup') }} </div>
                                                </div>
                                                <div class="icontext-item d-flex align-items-center gap-1">
