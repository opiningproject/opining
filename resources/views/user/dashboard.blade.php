                        ...
                        <div class="section-page-title main-page-title row justify-content-between">
                            ...
                            <div
                                ...
                                <span class="form-control-feedback">
                                    <img class="svg" src="{{ asset('images/search.svg') }}" alt="" height="32"
                                         width="32">
                                </span>
...
//                                        if ($dish->qty == 0 || $dish->out_of_stock == '1') {
                                            ...
                                            <div class="card food-detail-card">
                                                ...
                                                <button type="button" class="btn btn-xs-sm btn-custom-yellow"
                                                        ...
                                                        {{ $disableBtn }} id="dish-cart-lbl-{{ $dish->id }}">
                                                    {{--                                                @if ($dish->qty == 0 || $dish->out_of_stock == '1')--}}
                                                    @if ($dish->out_of_stock == '1')
                                                        {{ trans('user.dashboard.out_of_stock') }}
                                                    @else
                                                        {{ trans('user.dashboard.add') }}
                                                        <img src="{{ asset('images/plus.svg') }}" class="svg" height="9"
                                                             width="9">
                                                    @endif
                                                </button>
                                        ...
                                        <div class="cart-custom-tab cart-tab custom-tabs d-flex flex-column h-100">
                                            ...
                                            <div class="d-flex flex-column flex-fill tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade {{ !$zipcode ? 'show active' : '' }}"
                                                    ...
                                                    <div class="form-group addressMobile">
                                                        <label
                                                            class="form-label">{{ trans('user.cart.rest_address') }}</label>
                                                        <div class="d-flex align-items-center justify-content-between">
...
//                                                                if ($dish->dish->qty == 0 || $dish->dish->out_of_stock == '1') {
                                                                                    ...
                                                                                    <div class="cart-item-detail">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <label
                                                                                                    for="dishnameenglish"
                                                                                                    class="form-label">{{ trans('user.cart.add_notes') }}</label>
                                                                                                <input type="text"
                                                                                                       data-id="{{ $dish->id }}"
                                                                                                       maxlength="50"
                                                        ...
                                                        <input type="text" class="form-control bg-gray custom-control-with-icon ps-5" id="delivery_instruction" maxlength="50" value="{{ $user->cart ? $user->cart->delivery_note : '' }}" placeholder="{{ trans('user.cart.instruction') }}" />
                                                          ...
                                                          <span class="input-group-icon">
                                                            <img src="{{ asset('images/coupon-code.svg') }}" alt=""
                                                                 class="svg img-fluid" height="18" width="29">
                                                                    ...
                                                                    <div class="coupon-apply-btn">
                                                                        <button class="btn btn-xs-sm btn-custom-yellow"
                                                                                onclick="applyCoupon()"
                                                                                id="coupon_code_apply_btn" {{ !empty($couponCode) ? 'style=display:none' : '' }}> {{ trans('user.cart.apply') }} </button>
                                                                        <button class="btn btn-xs-sm btn-custom-yellow"
                                                                                onclick="removeCoupon()"
                                                                                id="coupon_code_remove_btn" {{ !empty($couponCode) ? '' : 'style=display:none' }}> {{ trans('user.cart.remove') }} </button>
                                                                    </div>
                                                                </div>
