                    ...
                    <div class="orders d-flex">
                        <div class=" orders-type">
                            ...
                            <div class="orders-list py-3 px-1">
                                ...
                                <div class="{{ $a_order->id == $order->id ? 'active':'' }} orders-item d-flex align-items-center justify-content-between gap-2" id="order-{{ $a_order->id }}">
                                    <div class="text-grp">
                                    ...
                                    <button class="border-none outline-none" onclick="orderDetail({{ $a_order->id }})">
                        ...
                        <div class="orders-type">
                            ...
                            <div class="orders-list py-3 px-1">
                                ...
                                <div class="{{ $ord->id == $order->id ? 'active':'' }} orders-item d-flex align-items-center justify-content-between gap-2" id="order-{{ $ord->id }}">
                                    <div class="text-grp">
                                        <div class="title">Order #{{ $ord->id }}</div>
                                        <div class="text">{{ $ord->created_at }}</div>
                                    </div>
                                    <div class="price"><span>€</span>{{ $ord->total_amount}}</div>
                                    <button class="border-none outline-none" onclick="orderDetail({{ $ord->id }})">
                                        <img src="{{ asset('images/chevron-down.svg') }}" class="img-fluid svg" alt="" width="32" height="32">
                                    </button>
                                </div>
                                @endforeach
                            ...
                            <div class="orderdetails-bill">
                                ...
                                <div class="list">
                                    <div class="list-item">
                                        ...
                                        <div class="number">€{{ $itemPrice }}</div>
                                    </div>
                                    <div class="list-item">
                            ...
                            <div class="orderdetails-total">
                                <div class="list">
                                    <div class="list-item">
                                        ...
                                        <div class="number">€{{ getOrderTotalPrice($itemPrice,$order) }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
