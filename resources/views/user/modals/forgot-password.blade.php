    ...
    <div class="modal-content">
      ...
      <div class="modal-body signin-form">
        <form id="forgot-pwd-form" method="POST">
          <h3 class="authenticationform-title mb-2">Forgot Password</h3>
          <div class="form-group prev-input-group custom-icon-input-group mb-0">
            <span class="input-group-icon"><img src="{{ asset('images/mail-icon2.svg') }}" alt="" width="18" height="12"  class="svg" /></span>
          ...
          <button type="submit" class="btn btn-custom-yellow fw-400 text-uppercase font-sebibold w-100 mt-xxl-2" id="forgot-pwd-btn">Send Password Reset Link</button>
        </form>
      </div>
    </div>
  </div>
