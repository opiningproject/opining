            ...
            <div class="modal-body">
                ...
                <div class="radio-tabs">
                    ...
                    <label class="status-option specific-day">
                        <input id="order-setting-date" type="radio" name="orderSetting" {{$payment_settings['order_setting_type'] == "2" ? 'checked' : ''}}/>
                ...
                <form class="order-setting-form" id="order-setting-form">
                    ...
                    <div class="date-range-section pt-4 pb-4 d-none" id="date-range">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-12">
                                <input type="hidden" class="order-setting-custom-time" value="{{ $payment_settings['expiry_date'] }}" >
                                <input type="text" placeholder="Select Date For Filter" class="form-control"
                                       id="order-setting-custom-time" aria-label="expiry_date" name="expiry_date" value="{{ $payment_settings['expiry_date'] }}" required>
