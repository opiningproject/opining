    ...
    <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                ...
                <label class="btn btn-sm btn-outline-custom-yellow text-muted-default" for="btnradio3"><?php echo e(trans('rest.settings.cms.privacy')); ?></label>

                <input type="radio" class="btn-check" name="content_nl" id="btnradio4" autocomplete="off" onchange="changeContent('terms-nl');" />
                <label class="btn btn-sm btn-outline-custom-yellow text-muted-default" for="btnradio4"><?php echo e(trans('rest.settings.cms.terms')); ?></label>
            </div>
        </div>

        <div class="custom-editor-box" id="privacy_box_nl" style="display: block;">
            <textarea id="privacy-nl">
            <?php echo e($privacy_policy_nl); ?>
...
</div><?php /**PATH E:\wamp\www\go-meal\resources\views/admin/settings/cms-nl.blade.php ENDPATH**/ ?>