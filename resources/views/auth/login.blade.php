                            ...
                            <div class="card-body signin-form">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <span class="input-group-icon">
                                        <img src="{{ asset('images/mail-icon2.svg') }}" class="svg" width="18"
                                             height="12">
                                    ...
                                    <span class="input-group-icon">
                                        <img src="{{ asset('images/Password-icon.svg') }}" class="svg" width="15"
                                             height="20">
                                    </span>
                                            ...
                                            <img src="{{ asset('images/passwordeye-icon.svg') }}" class="svg" width="21"
                                                 height="19">
                                        </span>
