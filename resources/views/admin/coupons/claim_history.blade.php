                                    ...
                                    <div class="rounded-custom-12 border-custom-1 py-3">
                                        <div class="claimhistory-table custom-table ">
                                                ...
                                                @foreach($orders as $key => $order)
                                                    <tr>
                                                        <td class="text-center"><span
                                                                class="text-muted-1">{{ $order->id }}</span></td>
                                                        <td class="text-center"><span
                                                                class="text-muted-1">{{ $order->user->full_name }}</span>
                                                        </td>
                                                        <td class="text-center"><span
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pt-3"
                                                ...
                                                {{ $orders->links() }}
                                                <div
                                                    class="ms-auto d-flex align-items-center custom-pagination justify-content-end w-100">
                                                    <label
                                                        class="text-nowrap">{{ trans('rest.button.rows_per_page') }}</label>
                                                    <select id="per_page_dropdown" onchange=""
                                                            class="form-control bg-white ms-2">
                                                        @for($i=5; $i<=20; $i+=5)
                                                            <option
