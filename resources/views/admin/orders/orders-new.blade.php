                            ...
                            <div class="header-filter-order d-flex align-items-center flex-wrap">
                                ...
                                <div class="dropdown custom-dropdown">
                                    ...
                                    <ul class="dropdown-menu order-filter" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            <label class="checkbox-label">
                                                <input type="checkbox" class="checkbox" id="online" name="online"><label
                                        ...
                                        <li>
                                            <label class="checkbox-label">
                                                <input type="checkbox" class="checkbox" id="manual" name="manual"><label
                                        ...
                                        <li>
                                            <label class="checkbox-label">
                                                <input type="checkbox" class="checkbox" id="delivery" name="delivery"><label
                                        ...
                                        <li>
                                            <label class="checkbox-label">
                                                <input type="checkbox" class="checkbox" id="takeaway" name="takeaway"><label
                                        ...
                                        <li>
                                            <label class="checkbox-label">
                                                <input type="checkbox" class="checkbox" id="delivered" name="delivered"><label
                                                            ...
                                                            <div class="order-col" id="order-{{ $ord->id }}" data-id="{{ $ord->id }}">
                                                                <div class="order-box">
                                                                    ...
                                                                    <div class="actions">
                                                                        ...
                                                                        <button
                                                                            class="orderDetails btn {{orderStatusBox($ord)->color }}">{{ orderStatusBox($ord)->text }}</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                @endforeach
