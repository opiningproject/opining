                        ...
                        <section class="custom-section checkout-section">
                            <div class="row checkout-form-steps">
                                        ...
                                        <div class="card custom-card h-100">
                                            <div class="card-body pb-0 checkout-form">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <label for="companyname" class="form-label">Add Delivery
                                                                instruction</label>
                                                            <input type="number" class="form-control"
                                                                   value="Like baby is sleeping don’t ring..."/>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group countrycode-phone-control">
                                                                <button class="dropdown-toggle no-arrow" type="button"
                                                    ...
                                                    <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control"
                                                                   value="ronaldwielinga@gmail.com"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="checkout-form-item">
                                    <div class="form-step-icon">
                                        <div class="icon-form">
                                            <img src="{{ asset('images/delivery-time-icon.svg') }}" alt="" class="svg"
                                                 height="28" width="28">
                                        </div>
                                    </div>
                                    <div class="cart-form-card-body d-block">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="custom-radio custom-checkbox-group mobile-mb-10">
                                                            <div class="radio">
                                                                ...
                                                                <label for="radio-1" class="radio-label">As Soon As
                                                                    Possible</label>
                                                            </div>
                                                            <div class="radio">
                                                                <input id="radio-2" name="radio" type="radio" checked>
                                                                <label for="radio-2" class="radio-label">customize
                                                                    Time </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="checkout-form-item">
                                    <div class="form-step-icon">
                                        <div class="icon-form">
                                            <img src="{{ asset('images/timer.svg') }}" alt="" class="svg" height="26"
                                                 width="26">
                                        </div>
                                    </div>
                                    <div class="cart-form-card-body cart-form-card-body-last d-block">
                                                ...
                                                <div class=" payment-nav">
                                                    <div class="payment-navigation">
                                                        ...
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab"
                                                            ...
                                                            <button class="nav-link" id="v-pills-ideal-tab"
                                                                    data-bs-toggle="pill"
                                                            ...
                                                            <button class="nav-link" id="v-pills-cashondelivery-tab"
                                                                    data-bs-toggle="pill"
                                                    ...
                                                    <div class="w-100">
                                                        <div class="tab-content w-100" id="v-pills-tabContent">
                                                            <div class="tab-pane fade" id="v-pills-ideal"
                                        ...
                                        <div class="form-check form-group custom-checkbox">
                                            ...
                                            <label class="form-check-label text-capitalize align-middle"
                                                   for="receiveemail"> Receive emails about discounts, push-mails and
                                                other updates </label>
                                        </div>
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-borderless">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <span class="bill-count">€{{ $zipcode }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr >
                                                                <td class="text-start">
                                                                ...
                                                                <td class="text-end">
                                                                    <span class="text-custom-light-green bill-count">-€({{ $user->cart->coupon_discount }})</span>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                            <tfoot>
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <span class="bill-total-count">€{{ $cartAmount + $serviceCharge }}</span>
                                                                </td>
                                                            </tr>
                                                            </tfoot>
                                                        </table>
