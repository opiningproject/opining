                                ...
                                <span class="input-group-icon">
                                  <img src="{{ asset('images/coupon-code.svg') }}" alt="" class="svg" height="18"
                                       width="29">
                                                                    ...
                                                                    <input type="text" class="form-control bg-gray custom-control-with-icon ps-5" style="padding-right: 95px"
