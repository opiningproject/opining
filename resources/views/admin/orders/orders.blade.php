                ...
                <div class="main-content d-flex flex-column h-100">
                    <div class="section-page-title mb-0 d-flex align-items-center justify-content-between gap-2 foodorder-page-title">
                        ...
                        <div class="btn-grp d-flex align-items-center flex-wrap">
                            <button class="btn d-flex align-items-center bg-white" data-bs-toggle="dropdown" aria-expanded="false"> 
                                <img src="{{ asset('images/filter-icon.svg') }}" alt="img" class="img-fluid svg" width="22" height="20">
                                <div class="text">Filter Orders</div>
                            </button>

                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('orders',['date_filter'=>1]) }}">Today</a></li>
                                <li><a class="dropdown-item" href="{{ route('orders',['date_filter'=>2]) }}">This week</a></li>
                                <li><a class="dropdown-item" href="{{ route('orders',['date_filter'=>3]) }}">This month</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="foodorder-box-list-wrp bg-white">
                            <div class="foodorder-box-list d-flex flex-column">
                                @if(count($orders))
                                    ...
                                    <div class="{{ $key == 0 ? 'active':'' }} foodorder-box-list-item d-flex" onclick="orderDetail({{ $ord->id }})" id="order-{{ $ord->id }}">
                                        <div class="details w-100 d-flex flex-column gap-3">
                                            <div class="title">Order #{{$ord->id}} | {{ $ord->created_at }}</div>
                                            <div class="icontext-grp d-flex align-items-center justify-content-between">
                                                <div class="icontext-item d-flex align-items-center gap-1">
                                                    <img class="svg" src="{{ asset('images/fork-knife-icon.svg') }}" class="img-fluid svg" alt="" height="22" width="22">
                                                    <div class="text">{{ $ord->order_type == OrderType::Delivery ? 'Delivery':'Pickup' }} </div>
                                                </div>
                                                <div class="icontext-item d-flex align-items-center gap-1">
                                                    <img src="{{ asset('images/hand-money-icon.svg') }}" alt="" class="img-fluid svg" width="30" height="29">
                                                    <div class="text">€{{ $ord->total_amount}}</div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="foodorder-box-details bg-white w-100 d-flex flex-column">
                            <div class="footer-box-details-header d-flex align-items-center justify-content-between gap-lg-3 flex-wrap">
                                <ul class="list-inline text-grp mb-0 p-0 d-flex align-items-center flex-fill">
                                    <li class="list-inline-item d-flex align-items-center">Order #{{$order->id }}</li>
                            ...
                            <div class="footer-box-main">
                                <div class="footer-box-main-orderdetails d-flex justify-content-between   ">
                                    ...
                                    <div class="footer-box-main-orderdetails-item d-flex align-items-start gap-2">
                                        <div class="text-grp">
                                            <div class="text">
                                                <span>Delivery Mode: </span>{{ $order->delivery_time }}
                                            </div>
                                            <div class="text">
                                ...
                                <div class="footer-main-total">
                                    ...
                                    <div class="footer-main-total-main">
                                        ...
                                        <div class="text-grp d-flex flex-column gap-3">
                                            ...
                                            <div class="text d-flex align-items-center justify-content-between gap-2">
                                                <div class="key">{{ $order->delivery_charge ? 'Delivery Charge':'Free Delivery' }}</div>
                            ...
                            <div class="foodorder-box-details-footer d-flex align-items-center justify-content-between gap-2">
                                <button class="btn btn-auto" onclick="window.print()">Print Label</button>
                                ...
                                <button class="btn active btn-auto" class="customize-foodlink button" onclick="changeOrderStatus({{ $order->id }},'{{ $order_status }}')">Move to '{{ $order_status }}'</button>
                                @endif
