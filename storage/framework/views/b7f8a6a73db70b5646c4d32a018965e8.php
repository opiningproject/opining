    ...
    <div class="modal-content">
      ...
      <div class="modal-body signin-form">
        <form id="sign-in-form" method="POST">
          ...
          <a class="btn btn-outline-secondary btn-default w-100 text-capitalize font-sebiregular font-18" href="<?php echo e(url('google/auth')); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
              ...
              <path d="M9.50014 18.9999C11.9539 18.9999 14.1835 18.0609 15.8693 16.5338L12.9291 14.0458C11.9753 14.7683 10.7897 15.2 9.50014 15.2C7.02925 15.2 4.93123 13.6245 4.14084 11.4258L1.04297 13.8126C2.61518 16.8891 5.80805 18.9999 9.50014 18.9999Z" fill="#4CAF50" />
              <path d="M18.815 7.63708H18.0498V7.59766H9.5V11.3976H14.8688C14.4926 12.4601 13.8091 13.3764 12.9275 14.0437C12.928 14.0433 12.9285 14.0433 12.9289 14.0428L15.8691 16.5308C15.6611 16.7198 18.9998 14.2475 18.9998 9.49761C18.9998 8.86065 18.9342 8.23889 18.815 7.63708Z" fill="#1976D2" />
            </svg>
...
</div><?php /**PATH /var/www/html/go-meal/resources/views/user/modals/signin.blade.php ENDPATH**/ ?>