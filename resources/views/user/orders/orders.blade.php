                                ...
                                @if(count($active_orders))
                                    <div class="orders-list py-3 px-0 pb-0">
                                        @foreach($active_orders as $key => $a_order)
                                            <div onclick="orderDetail({{ $a_order->id }})" style="cursor: pointer;" class="{{ $a_order->id == $order->id ? 'active':'' }} orders-item d-flex align-items-center justify-content-between gap-2" id="order-{{ $a_order->id }}">
                                                <div class="text-grp">
                                                    <div class="title">{{ trans('user.my_orders.order') }} #{{ $a_order->id }}</div>
                                ...
                                <div class="orders-type">
                                    ...
                                    <div class="orders-list py-3 px-1">
                                        @foreach($orders as $key => $ord)
                                            <div onclick="orderDetail({{ $ord->id }})" style="cursor: pointer;" class="{{ $ord->id == $order->id ? 'active':'' }} orders-item d-flex align-items-center justify-content-between gap-2" id="order-{{ $ord->id }}">
                                                <div class="text-grp">
                                                    <div class="title">{{ trans('user.my_orders.order') }} #{{ $ord->id }}</div>
                                ...
                                <div class="ordersdetails-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="btn-grp d-flex flex-wrap">
                                        ...
                                        <button onclick="location.href='{{ route('user.chat') }}'">
                                            <img src="{{ asset('images/needhelp-icon.svg') }}" class="img-fluid svg" alt="" width="27" height="25">
                                    ...
                                    <div
                                        ...
                                        @if($order->order_type == OrderType::Delivery)
                                            <div class="textgrp">
                                                ...
                                                <div class="text">
                                                    <img src="{{ asset('images/location-yellowicon.svg') }}" class="img-fluid svg me-2" alt="" width="12" height="16">
                                                        <?php
                                        ...
                                        @else
                                            <div class="textgrp">
                                                ...
                                                <div class="text">
                                                    <img src="{{ asset('images/house-icon.svg') }}" class="img-fluid svg me-2" alt="" width="18" height="18">
                                                    ...
                                                    <div class="orderdetails-desc-card orderdetails-flex-200">
                                                        ...
                                                        <div class="text-grp">
                                                            ...
                                                            <div class="text {{ getOrderDishIngredients($dish) == '' ? 'd-none' : '' }}">
                                                                <a href="javascript:void(0)" id="read-more-{{ $dish->id}}" onclick="readMore({{ $dish->id}})">
                                                                    {{ trans('user.my_orders.read_more') }}
                                                                </a>
                                                                <a href="javascript:void(0)" style="display:none;" id="close-{{ $dish->id}}" onclick="hideReadMore({{ $dish->id}})">
