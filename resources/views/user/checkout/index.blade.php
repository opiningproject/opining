                            ...
                            <form id="final-checkout-form">
                                                    ...
                                                    <div class="mobileStaticToggle" id="delivery-info-tab">
                                                        <div class="innerCon">
                                                            ...
                                                            <div class="textCon">
                                                                ...
                                                                <p class="mb-0">@if(session('zipcode'))
                              ...
                              <span>
                                                    ...
                                                    <div class="mobilecheckoutContent"
                                                         id="delivery-user-mobile-content">
                                                        <h4 class="custom-card-title-1 form-group">{{ trans('user.checkout.personal_detail') }}
                                                            <span
                                                                class="text-muted-lead-2">{{ trans('user.checkout.personal_detail_note') }} </span>
                                                        </h4>
                                                        <div class="row">
                                                            <div
                                                                class="col-xxl-6 col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                              ...
                              <span>
                                                    ...
                                                    <div class="mobilecheckoutContent"
                                                         id="delivery-type-mobile-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="radio">
                                                                        ...
                                                                        <label for="radio-2" id="customize-time"
                                                                               class="radio-label radio-del-time">{{ trans('user.checkout.customize_time') }} </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                              ...
                              <span>
                                                            ...
                                                            <div class="payment-navigation">
                                                                ...
                                                                <div class="nav flex-column nav-pills" id="v-pills-tab"
                                                                    ...
                                                                    <button class="nav-link active payment-type-tab"
                                                                            ...
                                                                            data-bs-toggle="pill"
                                                                            data-bs-target="#v-pills-ideal"
                                                                            type="button" role="tab"
                                                                            aria-controls="v-pills-ideal"
                                                                            aria-selected="true">
                                                                        <img src="{{ asset('images/ideal.svg') }}"
                                                                             alt="" height="22" width="25" class="svg">
                                                                        iDEAL
                                                                    </button>
                                                                    <button class="nav-link payment-type-tab"
                                                                        ...
                                                                        <img src="{{ asset('images/stripe.svg') }}"
                                                                             ...
                                                                             class="svg"> {{ trans('user.checkout.cc_card') }}
                                                                    </button>
                                                                    <button class="nav-link payment-type-tab"
                                                                            id="v-pills-cashondelivery-tab"
                                                                            data-type="2" data-bs-toggle="pill"
                                                                        ...
                                                                        <img src="{{ asset('images/cod.svg') }}" alt=""
                                                                             height="30" width="31"
                                                                             class="svg"> {{ trans('user.checkout.cod') }}
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            <div class="w-100">
                                                                <div class="tab-content w-100" id="v-pills-tabContent">
                                                                    ...
                                                                    <div class="tab-pane fade"
                                                                         id="v-pills-cashondelivery" role="tabpanel"
                                            ...
                                            <div class="form-check form-group custom-checkbox">
                                                <input class="form-check-input check-input-secondary" type="checkbox"
                                                       name="receive_mail" id="receiveemail"
                                                       value="1" {{ $user->enable_email_notification == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label text-capitalize align-middle"
                                                       for="receiveemail"> {{ trans('user.checkout.receive_update_emails') }} </label>
                                            </div>
                                            <div class="row">
                                                <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        <button type="submit"
                                                                class="align-middle btn btn-custom-yellow btn-default d-block w-100">{{ trans('user.checkout.pay') }}
