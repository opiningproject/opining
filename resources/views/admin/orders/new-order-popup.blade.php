            ...
            <div class="modal-content border-radius">
                ...
                <div class="modal-body pt-1">
                    <div class="text-center mb-4">
                        ...
                        @endphp
                        @if($hasOrders)
                            <button class="btn btn-site-theme fw-400 text-uppercase font-sebibold px-5 mt-2 font-18 order_details_button" data-id="{{ $order->id }}" >{{ trans('rest.food_order.order_details') }}</button>
                        @else
