                            ...
                            <div class="payment-navigation">
                              ...
                              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <button class="nav-link" id="v-pills-ideal-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ideal" type="button" role="tab" aria-controls="v-pills-ideal" aria-selected="true">
                                   <img src="{{ asset('images/ideal.svg') }}" alt="" height="22" width="25" class="svg">
                                Ideal 
                                </button>
                                ...
                                <img src="{{ asset('images/stripe.svg') }}" alt="" height="20" width="27" class="svg">
                                  Credit & Debit cards </button>
                                <button class="nav-link" id="v-pills-cashondelivery-tab" data-bs-toggle="pill" data-bs-target="#v-pills-cashondelivery" type="button" role="tab" aria-controls="v-pills-cashondelivery" aria-selected="false">
                                   <img src="{{ asset('images/cod.svg') }}" alt="" height="30" width="31" class="svg"> Cash on Delivery </button>
                              </div>
                            </div>
                            <div class="w-100">
