...
<div class="main-content">
    <div class="section-page-title mb-0 d-flex align-items-center justify-content-between gap-2 order-page-bar">
        ...
        <div class="d-flex align-items-center btn-grp-gap-10 btn-grp-tab">
            <button type="button" class="btn btn-site-theme d-flex align-items-center gap-3 justify-content-center"
                style="min-width: auto"><img src="{{ asset('images/customer.svg') }}" class="svg" height="20"
                    width="20" /> Customers</button>

            <button type="button" class="btn bg-white text-black d-flex align-items-center gap-3 justify-content-center"
                style="min-width: auto">
                <img src="{{ asset('images/email.svg') }}" class="svg" height="20" width="20" /> E-mails</button>
        </div>

        {{-- <h1 class="page-title me-auto">{{ trans('rest.food_order.orders') }} <span class="count count-order"> {{
                getOpenOrders() }} </span></h1> --}}
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th scope="col" class="text-center">{{ trans('rest.deliverers.last_name') }}
                                    </th>--}}
                            ...
                            <tbody id="delivererTbody">
                                ...
                                @for($i = 0; $i < 3; $i++)
                                    <tr id="deliverer-tr-$deliverers_id" draggable="true" class="delivererRow" data-id="1">
                                        <td class="text-left">
                                        ...
                                        <td class="text-left">
                                            <div class="position-relative dropdown-toggle dropdown-toggle-select">
                                        ...
                                        <td class="text-left">
                                            <div class="m-auto">
                                                <a class="btn m-auto btn-site-theme edit-deliverer-icon" id="edit-btn-1"
