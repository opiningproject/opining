<div class="tab-pane fade" id="open-orders" role="tabpanel" aria-labelledby="open-orders-tab">
    ...
    <?php if(count($openOrders) && $order != ''): ?>
            <?php $__currentLoopData = $openOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH E:\wamp\www\go-meal\resources\views/admin/orders/open.blade.php ENDPATH**/ ?>