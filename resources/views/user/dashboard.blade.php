                                                                                ...
                                                                                <div class="cart-custom-w-col-detail">
                                                                                    <div class="cart-item-detail">
                                                                                        ...
                                                                                        <div class="d-flex align-items-center">
                                                                                            ...
                                                                                            <span
                                                                                                class="item-desc" id="item-ing-desc{{ $dish->id }}">{{ getOrderDishIngredients($dish) }}</span>
                            ...
                            <a class="btn btn-custom-yellow btn-default d-block checkout-sticky-btn {{ count($cart) == 0 ? 'd-none' : '' }}"
                               ...
                               href="javascript:void(0)">
                                                                    <span class="align-middle"><span class="count_cart"><span
                                                                                class="count_num"
                                                                                id="cart-count-sticky">{{ isset(Auth::user()->cart) ? Auth::user()->cart->dishDetails->count() : 0 }}</span> <svg
