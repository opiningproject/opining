          ...
          <section class="custom-section category-list-section pb-0">
            ...
            <div class="category-list-item-grid">
              ...
              <div class="card food-detail-card">
                <p class="mb-0 offer-percantage"><?php echo e($dish->percentage_off); ?>%</p>

                <p class="mb-0 food-favorite-icon <?php echo e(isset($dish->favorite) ? 'd-none':''); ?>" onclick="favorite(<?php echo e($dish->id); ?>)" id="unfavorite-icon-<?php echo e($dish->id); ?>">
                ...
                <p class="mb-0 food-favorite-icon <?php echo e(isset($dish->favorite) ? '':'d-none'); ?>" onclick="unFavorite(<?php echo e($dish->id); ?>)" id="favorite-icon-<?php echo e($dish->id); ?>">
                  <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="food-image">
                  <img src="<?php echo e($dish->image); ?>" alt="burger imag" class="img-fluid" width="100" height="100" />
                </div>
...
<?php echo $__env->make('layouts.user-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/go-meal/resources/views/user/dashboard.blade.php ENDPATH**/ ?>