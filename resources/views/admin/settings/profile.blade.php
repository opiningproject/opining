<div class="tab-pane fade show active" id="restaurantProfile-tab-pane" role="tabpanel"
     aria-labelledby="restaurantProfile-tab" tabindex="0">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="restaurant_name"
                                   value="{{ $user->restaurant_name }}" required/>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            <label for="restaurantpermit" class="form-label">Restaurant Permit ID</label>
                            <input type="number" class="form-control" value="{{ $user->permit_id }}" name="permit_id"
                                   required/>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <div class="countrycode-phone-control position-relative">
                                ...
                                <input type="number" class="form-control" value="{{ $user->phone_no }}" name="phone_no"
                                       required>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                   value="{{ $user->user->first_name.' '.$user->user->last_name }}" name="owner_name"
                                   required/>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $user->user->email }}" name="email"
                                   readonly/>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $user->rest_address }}"
                                   name="rest_address" id="rest_address" required/>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                <button class="input-group-btn btn btn-custom-yellow btn-icon h-50px" type="button"
                                        id="button-addon2" data-bs-toggle="modal" data-bs-target="#changePasswordModal">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 my-auto">
                        <div class="form-group mb-0 mt-2">
                            <div
                                ...
                                <input class="form-check-input" type="checkbox" name="online_order_accept"
                                       role="switch" {{ $user->online_order_accept ? 'checked':'' }}>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" value="{{ $user->service_charge }}"
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="form-group mb-0">
                            ...
                            <div class="schedule-table bg-lightgray border-custom-1 rounded-custom-12"
                                 style="font-family: 'Sebino-Medium', sans-serif;font-size: 14px;">
                                <div class="row">
    ...
    <div class="row">
        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            <a class="btn btn-custom-yellow btn-default d-block">
                ...
                <button type="submit" class="align-middle border-0" id="profile-save-btn">Save</button>
            </a>
        </div>
    </div>
</div>
...
@section('script')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCgn-yE-BywHdBacEmRH9IWEFbuaM4PWGw&libraries=places&callback=initMap"
        async defer></script>
