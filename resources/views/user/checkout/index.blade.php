...
{{--                                                                                    <span class="order-total-item pe-2 mb-0">{{ $dishDetails->qty }}</span>--}}
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <div class="text "
                                                                                    ...
                                                                                    @php
                                                                                        $htmlString = getOrderDishIngredients1($dishDetails);
                                                                                        $cleanedHtmlString = str_replace('"', '', $htmlString);
                                                                                    @endphp

                                                                                    <ul class="items-additional mb-2" id="item-ing-desc{{ $dishDetails->id }}">
                                                                                        {!! $cleanedHtmlString !!}
                                                                                    </ul>
