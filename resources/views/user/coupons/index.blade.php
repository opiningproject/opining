            ...
            <div class="customize-tab setting-tab">
                <ul class="nav nav-tabs flex-nowrap" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="unused-coupons-tab" data-bs-toggle="tab" data-bs-target="#unused-tab-pane" type="button" role="tab" aria-controls="unused-tab-pane" aria-selected="false">
                            {{ trans('user.coupons.unused') }}
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="expired-coupons-tab" data-bs-toggle="tab" data-bs-target="#expired-tab-pane" type="button" role="tab"
                                aria-controls="expired-tab-pane" aria-selected="false">{{ trans('user.coupons.expired') }}
                        </button>
                    </li>
                </ul>
