                                    ...
                                    {{-- <div class="swiper-slide">
                                        <div class="offer-card-banner offercard-slider w-100 mb-0">
                                            <div class="card position-relative">
                                                ...
                                                <div class="card-body">
                                                    <div class="text-content">
                                                        <h2>Get <strong>free drinks</strong> on each dish you order on our own website</h2>
                                                        <a href="#"
                                                            class="btn btn-site-theme fw-400 text-uppercase font-sebibold">Know More</a>
                                                    </div>

                                                    <div class="img-content">
                                                        <img src="{{ asset('images/home-slide-two.png') }}"
                                        ...
                                        <tr>
                                            <td class="text-start">
                                                ...
                                                <span class="text-muted-1 minimum_amount"
                                                    style="display: none">({{ trans('user.cart.minimum_amount') . '' . number_format($min_order_price, 2) }})
                                                </span>
                                            </td>
                                            <td class="text-end">
